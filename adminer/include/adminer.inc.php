...
class Adminer {
	...
	*/
	function head() {
		?>
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['adminerAssetsUrl']?>/externals/jush/jush.css">
<?php
		return true;
	}
...
<?php
		if ($missing == "auth") {
			...
			if (support("sql")) {
				?>
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/externals/jush/modules/jush.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/externals/jush/modules/jush-textarea.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/externals/jush/modules/jush-txt.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/externals/jush/modules/jush-<?php echo $jush; ?>.js"></script>
<script type="text/javascript">
<?php
				if ($tables) {
					$links = array();
