...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['adminerAssetsUrl']?>/default.css">
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/functions.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->params['adminerAssetsUrl']?>/editing.js"></script>
<?php if ($adminer->head()) { ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo Yii::app()->params['adminerAssetsUrl']?>/favicon.ico">
<link rel="apple-touch-icon" href="<?php echo Yii::app()->params['adminerAssetsUrl']?>/favicon.ico">
<?php if (file_exists("adminer.css")) { ?>
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['adminerAssetsUrl']?>/adminer.css">
<?php } ?>
<?php } ?>
